...
background:#eee; font-size:24px;'> تقرير   الكلي   </div>              
...
<td>
 ...
 <td> <a href="#" onclick = 'return false;' onmousedown='reports("report_all_done.php");'class="btn btn-primary btn-user btn-block"> بحث</a></td>
