...
background:#eee; font-size:24px;'> تقرير عن المقابلات   </div>              
...
<td>
 ...
 <td> <a href="#" onclick = 'return false;' onmousedown='reports("report_mogabla_done.php");'class="btn btn-primary btn-user btn-block"> بحث</a></td>
 ...
 <td width='20%'>مقابلات بين فترتين :</td>
