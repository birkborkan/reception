...
background:#eee; font-size:24px;'> تقرير   عن العمليات   </div>              
...
<td>
 ...
 <td> <a href="#" onclick = 'return false;' onmousedown='reports("report_op_done.php");'class="btn btn-primary btn-user btn-block"> بحث</a></td>
 ...
 <td width='20%'>   تقرير العمليات بين فترتين :</td>
