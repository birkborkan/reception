...
background:#eee; font-size:24px;'> تقرير عن الغرف   </div>              
...
<td>
 ...
 <td> <a href="#" onclick = 'return false;' onmousedown='reports("report_khorfa_done.php");'class="btn btn-primary btn-user btn-block"> بحث</a></td>
 ...
 <td width='20%'>الغرف بين فترتين :</td>
