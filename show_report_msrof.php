...
background:#eee; font-size:24px;'> تقرير   عن المصروفات   </div>              
...
<td>
 ...
 <td> <a href="#" onclick = 'return false;' onmousedown='reports("report_msrof_done.php");'class="btn btn-primary btn-user btn-block"> بحث</a></td>
 ...
 <td width='20%'>   تقرير المصروفات بين فترتين :</td>
