...
background:#eee; font-size:24px;'> تقرير عن الفحوصات   </div>              
...
<td>
 ...
 <td> <a href="#" onclick = 'return false;' onmousedown='reports("report_fahis_done.php");'class="btn btn-primary btn-user btn-block"> بحث</a></td>
 ...
 <td width='20%'>عمليات بين فترتين :</td>
